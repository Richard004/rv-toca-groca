...
export function buildFurnishedDefaultWorld() {
  ...
  const entities = [
    // —— Obývák: celá scéna na jedné obrazovce ——
    furn('tv-tv-0', 'living', 0.52, 0.12),
    furn('clocks-clock-0', 'living', 0.72, 0.08),
    furn('pictures-picture-0', 'living', 0.82, 0.10),
    furn('lamp-lamp-0', 'living', 0.02, 0.38),
    furn('plants-plant-0', 'living', 0.90, 0.36),
    furn('plants-plant-1', 'living', 0.08, 0.28),
    furn('sofa-sofa-0', 'living', 0.02, 0.50),
    furn('chair-chair-3', 'living', 0.58, 0.54),
    furn('rug-rug-0', 'living', 0.12, 0.64),
    furn('table-table-0', 'living', 0.28, 0.56),
    furn('vases-vases-1', 'living', 0.34, 0.52),
    furn('posters-poster-0', 'living', 0.42, 0.14),
    toy('toy-teddy', 'living', 0.22, 0.58),
    toy('toy-book', 'living', 0.36, 0.60),
    toy('toy-paint', 'living', 0.44, 0.58),
    meal('food-cookie', 'living', 0.30, 0.54),
    chr('zuzana', 'living', 0.14, 0.42, { emotion: 'happy' }),
    chr('anetka', 'living', 0.30, 0.44, { emotion: 'happy' }),
    chr('liza', 'living', 0.46, 0.48),
    chr('cookie', 'living', 0.62, 0.50),
